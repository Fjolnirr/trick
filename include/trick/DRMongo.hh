...
namespace Trick {
    ...
    The DRMongo recording format is a comma separated value file named log_<group_name>.csv.  The contents
    ...
    */
    ...
    class DRMongo : public Trick::DataRecordGroup {
        ...
        public:
            ...
            /**
             @brief @userdesc Create a new Ascii mongo data recording group.
             @par Python Usage:
             @code <my_drg> = trick.DRMongo("<in_name>") @endcode
             @copydoc Trick::DataRecordGroup::DataRecordGroup(string in_name)
             */
            DRMongo( std::string in_name) ;
